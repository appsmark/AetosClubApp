...
export class DataGame {
    ...
    teams = [
        ...
        ["JC1", "regio-oost/JA1C2", "jongens-c/1"],
        ["JC2", "regio-oost/JA1C2", "jongens-c/2"],
        ["JC3", "regio-oost/JA1C2", "jongens-c/3"],
        ["JC4", "regio-oost/JA1C2", "jongens-c/4"],
        ["MA1", "regio-oost/MA2I2", "meisjes-a/1"],
        ["MA2", "regio-oost/MA2I2", "meisjes-a/2"],
        ["MB1", "regio-oost/MA2I2", "meisjes-b/1"],
        ["MB2", "regio-oost/MA2I2", "meisjes-b/2"],
        ["MB3", "regio-oost/MA2I2", "meisjes-b/3"],
        ["MB4", "regio-oost/MA2I2", "meisjes-b/4"],
        ["MB5", "regio-oost/MA2I2", "meisjes-b/5"],
        ["MB6", "regio-oost/MA2I2", "meisjes-b/6"],
        ["MC1", "regio-oost/CNH8Q1U", "meisjes-c/1"],
        ["MC2", "regio-oost/MA2I2", "meisjes-c/2"],
        ["MC3", "regio-oost/MA2I2", "meisjes-c/3"],
        ["MC4", "regio-oost/MA2I2", "meisjes-c/4"],
        ["MC5", "regio-oost/MA2I2", "meisjes-c/5"],
        ["MC6", "regio-oost/MA2I2", "meisjes-c/6"],
        ];
